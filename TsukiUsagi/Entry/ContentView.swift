...
private extension ContentView {
    ...
    func overlays(for context: LayoutContext, safeAreaInsets: EdgeInsets) -> some View {
        ...
        SideMenuView(isPresented: $showingSideMenu)
            .zIndex(2002)
        savedToast(show: showSavedToast, safeAreaInsets: safeAreaInsets)
        historyToast(show: showHistoryToast, message: historyToastMessage, safeAreaInsets: safeAreaInsets)
        historySaveBanner(show: showHistorySaveBanner, safeAreaInsets: safeAreaInsets) {
            historyVM.retryPendingSave()
        }
        silentCompleteChip(show: showSilentCompleteChip, safeAreaInsets: safeAreaInsets)
    }
